...
class WebsiteRepository
{
	public function getPollutionAQI()
	{
		...
		foreach ($locations as $location) {
			...
			foreach ($aqis as $aqi) {
				$aqiArr = [];
				$aqiArr = [$this->getSo2AirQualityIndexAttr($aqi->so2), $this->getNoxAirQualityIndexAttr($aqi->nox), $this->getPm2AirQualityIndexAttr($aqi->pm2), $this->getPm10AirQualityIndexAttr($aqi->pm10), $this->getCoAirQualityIndexAttr($aqi->co), $this->getO3AirQualityIndexAttr($aqi->o3), $this->getNh3AirQualityIndexAttr($aqi->nh3)];
