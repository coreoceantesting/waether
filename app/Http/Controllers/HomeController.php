...
class HomeController extends Controller
{
    ...
    public function home(Request $req)
    {
        ...
        if ($setting->config_name == "rainy_day") {
            ...
            return view('website.home')->with(['locations' => $locations, 'totalRain' => $totalRain, 'lastdayRain' => $lastdayRain, 'currentRain' => $currentRain, 'prograsiveRain' => $prograsiveRain, 'data' => $data, 'setting' => $setting, 'lastDayTemp' => $lastDayTemp, 'bannerImage' => $bannerImage, "lastDayTotalRainAvg" => $lastDayTotalRainAvg]);
        } else {
