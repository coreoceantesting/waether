        ...
        <div class="col-md-10">
            ...
            <div class="card">
              <!--    <div class="card-warning"> -->
                <div class="card-header">Edit Pollution Location</div>
  
                <div class="card-body">
                    <form action="{{ url('admin/pollution/location/update') }}" method="POST">
                        
                        @csrf
                        <input type="hidden" name="id" value="{{ $location->id }}">
                        <label>Location</label>
                        <input required="" type="text" name="name" value="{{ $location->name }}" class="form-control">
                        <br>
                        <label>Status</label>
